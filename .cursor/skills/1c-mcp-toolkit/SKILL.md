...
name: 1c-mcp-toolkit
description: >
  Прямой HTTP API к живой запущенной базе 1С:Предприятие Конвертация данных через обработку
...
Используется когда LLM-агент работает с живой базой "Конвертация данных 2" (тесты, диагностика, прямой
