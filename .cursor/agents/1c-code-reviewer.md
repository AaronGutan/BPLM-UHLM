...
description: "Этот агент следует использовать, когда нужно проверить код 1C на баги, читаемость, соответствие стандартам и правилам из 1c-bsl-core.mdc. Используй проактивно после написания или изменения кода."
model: fast
color: orange
---
