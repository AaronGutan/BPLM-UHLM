...
Спецификация формата управляемых форм 1С:Предприятие 8.3 (version 2.20 для платформы 8.3.27+; ранее 2.17).
...
Все 17 namespace-деклараций **идентичны** во всех формах конфигурации. Атрибут `version` для платформы 8.3.27+ — `"2.20"` (навыки проекта генерируют `2.20`).
